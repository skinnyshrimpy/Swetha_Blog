...
This plot is easier find the age gorup within cvd! As age increases, the chance of having cardiovascular disease (CVD) also increases.
...
## 3. Age, carstair and smoking behiviour
...
## 4. How their social class impact their smoking behiviour?
...
1.  Strong Correlation between scoial class and smoking behiviour!

2.  Better-off people smoke less.
...
## 5. Gender vs Smoking behiviour and CVD
...
1.  Males who are ex-smokers seem to have a higher chance of CVD.

2.  Males who never smoke also have higher cvd risks than expected (Age factor) But why not for female?

3.  Females who never smoked are less likely to have CVD.

4.  Females who are ex-smokers seem to have without CVD than expected.

5.  It’s surprising that female ex-smokers have more without CVD than expected, while male ex-smokers have higher CVD cases!!

6.  Overall, smoking habits does affect CVD differently for males and females.

### (b) Bar Filled Graph

```{r}
scottish_CVD_df %>%
gf_bar(~ cvddef, fill = ~sex, position = "fill") %>%
  gf_labs(
...
1.  But why here it looks like there's no difference in age groups?

## Conclusion

1.  From the Scottish CVD dataset, it’s clear that age plays the biggest role in cardiovascular disease. Older people are far more likely to have CVD.

2.  Smoking also increases risk, especially among older males. Ex-smokers often end up in the CVD-positive category, probably they might have quit after experiencing health problems.

3.  Although social deprivation influence smoking habits. People from more deprived or lower social classes tend to smoke more.

4.  Gender patterns show that men generally have higher CVD rates. Women, even when they smoke, they have fewer CVD cases!
