...
-Inference 1. From the mosaic plot, it shows that age and CVD are strongly correlated.
...
-Inference 1. Younger people are usually never or light smokers. Is there a link between age, deprivation, and smoking type?
...
-Inference 1. For every smoking group, people with CVD are older than those without CVD.
...
-Inference 1. There isn’t much of a connection between age and deprivation within each smoking group here.
...
-Inference 1. Although heavy smokers appear slightly more deprived on average, the differences are minor.
...
-Inference 1. People with lower social and economic status (lower social class, higher Carstairs index) are more likely to live in deprived areas and to smoke more.
