...
## False Hypothesis - Gender vs Smoking behiviour and CVD 
...
1. The Scottish CVD dataset suggests that age is also the strongest reason for cardiovascular disease, with prevalence rising sharply after age 50.

2. The social class (in relation to class) and Carstairs deprivation index suggest that the lower socioeconomic group are bearing a disproportionate amount of the CVD risk. 

3. Sex appears to be less important than age, smoking or deprivation.