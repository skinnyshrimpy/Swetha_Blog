...
Exploring and Analysing patterns of a dataset about fertility, demographics and weeks worked in 1979.
...
| gender1 | indicating gender of first child. |
| gender2 | indicating gender of second child. |
| age | age of mother at census. |
| afam | Is the mother African-American? |
| hispanic | Is the mother Hispanic? |
| other | Is the mother's ethnicity neither African-American nor Hispanic, nor Caucasian? |
...
Fertility_ethnicity_factor %>%
  ...
  gf_col(n ~ ethnicity, fill = ~morekids, position = "stack") %>%  
  gf_labs(
